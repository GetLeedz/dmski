...
function buildQuantitativeForensicPrompt(protectedPersonName = "", opposingPartyName = "") {
  ...
  return [
    ...
    "- WICHTIG: Die Person UEBER DIE das Dokument handelt (Patient, Kind, Betroffener) MUSS in der personen-Liste stehen! Beispiel: Bericht ueber 'Timur Schifferli' → {\"name\": \"Timur Schifferli\", \"rolle\": \"Kind\"}.",
    "- STRIKTE NAMENREGEL: Im 'name'-Feld NUR den echten Personennamen (Vorname Nachname). KEINE Funktion, KEINEN Titel, KEINE Institution, KEIN Geburtsdatum in den Namen aufnehmen.",
    "  Falsch: {\"name\": \"Jugendforensik Benedict Weizenegger Leiter\"} | Richtig: {\"name\": \"Benedict Weizenegger\", \"rolle\": \"Leiter Jugendforensik\"}",
    "  Falsch: {\"name\": \"Schifferli Timur, geb. 27.03.2013, m\"} | Richtig: {\"name\": \"Schifferli Timur\", \"rolle\": \"Kind\"}",
    "",
