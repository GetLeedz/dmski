...
function buildQuantitativeForensicPrompt(protectedPersonName = "", opposingPartyName = "") {
  ...
  return [
    ...
    "Die Gegenpartei kann die benachteiligte Person durch wiederholte institutionelle Attacken zerstoeren.",
    "Diese Muster sind STARK NEGATIV fuer die Gegenpartei und STARK NEGATIV fuer die benachteiligte Person (als Opfer):",
    "",
    "POLIZEI-MUSTER (+3 Negativ fuer Gegenpartei pro Vorfall):",
    "- Wiederholte Polizeianzeigen, Polizeibesuche, Polizeieinsaetze gegen die benachteiligte Person",
    ...
    "- Ergebnis 'keine Fallerroeffnung / keine strafbaren Handlungen' = ENTLASTUNG der benachteiligten Person (+2 Positiv)",
    "",
    ...
    "- PERSONEN-REGEL: Liste in 'personen' NUR Namen auf, die EXPLIZIT im Dokumenttext vorkommen. Fuege NIEMALS die Keywords aus BENACHTEILIGTE_PERSON_KEYWORDS oder GEGENPARTEI_KEYWORDS als Personen hinzu, es sei denn diese Namen tauchen tatsaechlich im Dokumenttext auf.",
      ...
      messages: [
        {
          ...
          content: isChatHint
            ...
            : [
              ...
              "",
              `KONTEXT: Benachteiligte Person im Fall = [${focusKeywords}], Gegenpartei = [${referenceKeywords}].`,
              "Diese Namen dienen NUR der Sentiment-Zuordnung. Fuege sie NICHT als Personen hinzu wenn sie nicht im Bild vorkommen.",
              "",
              "JSON-SCHEMA (exakt einhalten):",
              "{",
          ...
          content: [
            {
              ...
              text: [
                ...
                "   Wenn ein Name nicht im Bild sichtbar ist, darf er NICHT in 'personen' erscheinen.",
                "   Die Keywords aus dem System-Prompt (Benachteiligte/Gegenpartei) sind NUR fuer die",
                "   Zuordnung da – fuege sie NICHT als Personen hinzu, wenn sie im Bild nicht vorkommen.",
                "",
