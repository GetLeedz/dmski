...
const SYSTEM_PROMPT = [
  ...
  "   - Verschreibung starker Medikamente OHNE persoenlichen Patientenkontakt (Fernbehandlung per Chat/Telefon/Social Media)?",
  ...
  "     koerperlichen Folge fuehrt (Unfall, Nebenwirkungen, Hospitalisierung), und diese Folge dazu fuehrt,",
  "     dass eine Person an einem juristisch relevanten Termin (Befragung, Anhoerung, Verhandlung) NICHT",
  "     teilnehmen kann → Pruefe ob die ZEITLICHE ABFOLGE auf eine gezielte Obstruktion hindeutet.",
  "   - TITELMISSBRAUCH: Nutzt eine Partei ihren beruflichen Titel (Arzt, Psychiater, Therapeut) aus,",
  "     um Personen im Umfeld der Fokus-Partei medizinisch zu beeinflussen oder handlungsunfaehig zu machen?",
  "   - VERBINDUNG PRUEFEN: Steht der verschreibende Arzt in verwandtschaftlicher oder persoenlicher",
  "     Beziehung zur Gegenpartei? Wenn ja: INTERESSENKONFLIKT und moeglicherweise rechtswidrig.",
  "",
...
const CROSS_DOC_SYSTEM_PROMPT = [
  ...
  "   - Verschreibungen ohne persoenlichen Kontakt (Fernbehandlung per Chat/Telefon/Social Media)?",
  ...
  "   - KAUSALKETTE DOKUMENTUEBERGREIFEND PRUEFEN: Verschreibung (Dokument A) → Unfall/Hospitalisierung",
  "     (Dokument B) → verpasster Termin/Befragung (Dokument C). Wenn diese Kette zeitlich zusammenpasst",
  "     → KRITISCHER BEFUND: moeglicherweise gezielte Obstruktion durch medizinische Manipulation.",
  "   - TITELMISSBRAUCH PRUEFEN: Nutzt die Gegenpartei oder ein Familienmitglied der Gegenpartei",
  "     einen beruflichen Titel, um Personen im Umfeld der Fokus-Partei handlungsunfaehig zu machen?",
