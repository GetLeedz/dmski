...
const CROSS_DOC_SYSTEM_PROMPT = [
  ...
  "",
  "6. INSTITUTIONELLE ZERSTOERUNGSMUSTER (HOECHSTE PRIORITAET):",
  "   - Wiederholte Polizeianzeigen, Polizeibesuche, Bedrohungsmanagement-Meldungen",
  "   - Wiederholte KESB-Meldungen, Gefaehrdungsmeldungen, Jugendamt-Interventionen",
  "   - AUCH WENN die Polizei/Behoerde NICHTS feststellt (keine Fallerroeffnung, keine strafbaren Handlungen)",
  "   - Die BLOSSE HAEUFUNG solcher Dokumente im Dossier ist ein Muster systematischer Zerstoerung",
  "   - Jeder Polizeieinsatz hinterlaesst Spuren in Datenbanken die bei Gericht schaden",
  "   - Dieses Muster hat die HOECHSTE Gewichtung weil es eine Person ueber Jahre zerstoeren kann",
  "   - Erkenne: Wer hat diese Meldungen ausgeloest? Die Gegenpartei oder Dritte?",
  "",
  "### AUSGABE-FORMAT:",
